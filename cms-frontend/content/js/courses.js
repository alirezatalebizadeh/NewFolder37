...
let titleCourseInput = document.querySelector('#course-title-input')
let priceCourseInput = document.querySelector('#course-price-input')
let categoryCourseInput = document.querySelector('#course-category-input')
let timeCourseInput = document.querySelector('#course-time-input')
